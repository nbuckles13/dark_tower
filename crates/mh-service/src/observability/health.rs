//! Health endpoints for Media Handler (ADR-0011)
//!
...
//! - `ready`: True when MH is registered with GC and can accept media

use axum::{extract::State, http::StatusCode, routing::get, Router};
use std::sync::atomic::{AtomicBool, Ordering};
use std::sync::Arc;

/// Health state for the Media Handler.
///
