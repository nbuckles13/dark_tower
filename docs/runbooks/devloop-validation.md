...
| `WARN frame-vectors: cross-language property NOT established` | **Expected on every green run until story task 15, not a fault.** The TypeScript codec is not yet gated against the vectors. Non-suppressible by design. | §6.3 |
