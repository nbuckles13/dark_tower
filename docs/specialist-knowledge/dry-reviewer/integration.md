...
**Added**: 2026-01-23
**Related files**: `crates/gc-service/src/services/ac_client.rs:28-45`, `crates/ac-service/src/models/mod.rs:75-110`
...
**Related files**: `crates/gc-service/src/services/mh_selection.rs`, `crates/gc-service/src/repositories/meeting_controllers.rs`
...
**Added**: 2026-01-25
**Related files**: `crates/gc-service/src/`, `crates/mc-service/src/`
...
**Related files**: `crates/mc-service/src/grpc/gc_client.rs`, `crates/gc-service/src/services/mc_client.rs`
...
**Added**: 2026-01-28
**Related files**: `crates/gc-service/src/errors.rs`, `crates/ac-service/src/errors.rs`
...
**Added**: 2026-01-29
**Related files**: `crates/ac-service/src/config.rs:184-219`, `crates/gc-service/src/config.rs:138-163`
...
**Added**: 2026-01-30
**Related files**: `crates/mc-service/src/main.rs:289-319`, `crates/gc-service/src/main.rs:204-253`, `crates/ac-service/src/main.rs:136-189`
...
**Added**: 2026-01-30
**Related files**: `crates/mc-service/src/main.rs:56-62`, `crates/gc-service/src/main.rs:46-53`, `crates/ac-service/src/main.rs:24-32`
...
**Added**: 2026-02-02
**Related files**: `crates/common/src/token_manager.rs:68-71`, `crates/mc-service/src/grpc/gc_client.rs:60-63`
...
**Added**: 2026-02-02
**Related files**: `crates/common/src/token_manager.rs:319-324`, `crates/gc-service/src/services/ac_client.rs:133-136`
...
**Related files**: `crates/mc-service/src/grpc/gc_client.rs:645-659`, `crates/mc-service/tests/gc_integration.rs:267-279`
...
**Added**: 2026-02-02
**Related files**: `crates/mc-service/src/main.rs:145-170`
...
**Added**: 2026-02-04
**Related files**: `crates/gc-service/src/middleware/http_metrics.rs`, `crates/ac-service/src/middleware/http_metrics.rs`, `crates/gc-service/src/observability/metrics.rs`, `crates/ac-service/src/observability/metrics.rs`
...
**Added**: 2026-02-12
**Related files**: `crates/gc-service/src/tasks/generic_health_checker.rs:100`, `crates/gc-service/src/tasks/health_checker.rs:78`, `crates/gc-service/src/tasks/mh_health_checker.rs:78`
...
**Added**: 2026-02-05
**Related files**: `crates/mc-service/src/actors/metrics.rs:348-389`
