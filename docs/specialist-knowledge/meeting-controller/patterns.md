...
**Added**: 2026-01-25
**Related files**: `crates/mc-service/src/actors/controller.rs`, `crates/mc-service/src/actors/meeting.rs`, `crates/mc-service/src/actors/connection.rs`
...
**Added**: 2026-01-25
**Related files**: `crates/mc-service/src/actors/meeting.rs` (tests)
...
**Added**: 2026-01-25
**Related files**: `crates/mc-service/src/error.rs`
...
**Added**: 2026-01-25
**Related files**: `crates/mc-service/src/redis/lua_scripts.rs`, `crates/mc-service/src/redis/client.rs`
...
**Added**: 2026-01-28
**Related files**: `crates/mc-service/src/config.rs`, `crates/mc-service/src/actors/session.rs`
...
**Added**: 2026-02-02
**Related files**: `crates/mc-service/src/grpc/gc_client.rs` (tests), `crates/mc-service/tests/gc_integration.rs`
...
**Added**: 2026-02-02
**Related files**: `crates/common/src/token_manager.rs`, `crates/mc-service/Cargo.toml`
...
**Added**: 2026-02-05
**Related files**: `crates/mc-service/src/observability/health.rs`, `crates/ac-service/src/health.rs`
...
**Added**: 2026-02-05
**Related files**: `crates/mc-service/tests/health_integration.rs`
...
**Added**: 2026-02-05
**Related files**: `crates/mc-service/src/actors/controller.rs`, `crates/mc-service/src/actors/meeting.rs`, `crates/mc-service/src/main.rs`
